  ...
  <body class="bg-white font-sanscalp">
    ...
    <header>
          ...
          <div class="flex-none gap-2">
            <div class="hidden md:block px-5">
              <span class="flex gap-10 transition-all">
                <span class="text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm lg:text-xl"><a href="#">Home</a></span>
      ...
      <div class="grid hidden grid-rows-5 justify-center gap-6 border-2 bg-white text-center shadow-lg transition-all md:hidden" id="mobile-menu">
        <span class="pt-3 text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm md:font-semibold lg:text-xl"><a href="#">Home</a></span>
        <span class="text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm md:font-semibold lg:text-xl"><a href="BuyTicket.html">Buy Ticket</a></span>
        <span class="text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm md:font-semibold lg:text-xl"><a href="#">About</a></span>
        <span class="text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm md:font-semibold lg:text-xl"><a href="#">Contact Us</a></span>
        <span class="pb-3 text-primary duration-300 ease-in hover:text-[#e6ce20] md:text-sm md:font-semibold lg:text-xl"><a href="Login.html">Login</a></span>
      </div>
    </header>
    <!-- End Header section -->
    <!-- Main section -->
              ...
              <div class="flex flex-col items-center justify-between space-y-4 md:space-y-7 lg:flex-col xl:flex-row xl:space-x-5 xl:space-y-0">
                  ...
                  <div>
                    <span class="mb-2 text-base text-textColor sm:mb-2 sm:text-xl">Generated Ticket Number: </span>
                      <span class="text-red-400 text-base font-semibold ">TN20151</span>
                  </div>
              </div>
          </div>
        </div>
