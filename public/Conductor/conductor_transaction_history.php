                ...
                <div class="bg-white overflow-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Transaction ID</th>
                        ...
                        <tbody class="text-gray-700">
                            <tr>
                                <td class="text-left py-3 px-4"><a class="">8271BCDEF67890</a></td>
                                ...
                                <td class="text-left py-3 px-4"><a class="text-red-500 font-semibold">₱745</a></td>
