            ...
            <div class="grid grid-cols-1 items-center justify-items-center gap-10 pt-10 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="h-[250px] sm:h-[390px] md:h-[410px] w-full overflow-hidden rounded-md shadow-lg shadow-[#999c9aa5]">
                    ...
                    <div class="flex flex-col items-center justify-between rounded-b-3xl p-3 sm:p-4 md:p-5 lg:flex-col xl:p-0 2xl:flex-row 2xl:p-5">
                        ...
                        <div>
                            <a href="buy_ticket.php" id="lugar_terminal"  class="mt-4 flex flex-row-reverse items-center rounded-xl bg-[#d5c812] px-6 py-1 text-lg text-white transition-all duration-300 ease-in hover:bg-primary hover:opacity-85 sm:mt-0 sm:px-8 sm:py-3 sm:text-xl md:px-7 md:text-xl lg:px-5 lg:py-2">
                                Buy Ticket
            ...
            terminal.forEach((element) => {
                element.addEventListener('click', (e) => {
                    ...
                    Swal.fire({
                        ...
                        text: "You need to login first, before Buyticket",
                        icon: "error"
                    }).then((result) => {
