...
<body>
  ...
  <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="conductor_dashboard.php" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Conductor</a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            <a href="conductor_dashboard.php" class="flex items-center text-white py-4 pl-6 nav-item">
        ...
        <a href="conductor_dashboard.php" class="absolute w-full upgrade-btn bottom-0 active-nav-link text-white flex items-center justify-center py-4">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-auto">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    ...
                    <a href="../Logout/logout_destroy.php" class="block px-4 py-2 account-link hover:text-white">Sign Out</a>
                </div>
            </div>
        </header>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                <a href="conductor_dashboard.php" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
